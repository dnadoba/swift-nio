...
struct IPv4Header: Hashable {
    ...
    init(
        version: UInt8 = 4,
        internetHeaderLength: UInt8 = 5,
        differentiatedServicesCodePoint: UInt8 = 0,
        explicitCongestionNotification: UInt8 = 0,
        totalLength: UInt16,
        ...
        self.differentiatedServicesCodePoint = differentiatedServicesCodePoint
        self.explicitCongestionNotification = explicitCongestionNotification
...
extension IPv4Header: NonThrowingByteBufferSerialisable & StaticallySized {
    var writer: some NonThrowingByteBufferSerialisable & StaticallySized {
        self.versionAndIhl
        self.dscpAndEcn
        self.totalLength
        self.identification
