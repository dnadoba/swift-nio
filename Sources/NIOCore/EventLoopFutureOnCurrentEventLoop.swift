...
extension EventLoopFutureOnCurrentEventLoop: Sendable {}
#endif
...
extension EventLoopFutureOnCurrentEventLoop {
    ...
    ) -> EventLoopFutureOnCurrentEventLoop<(Value, OtherValue)> {
    ...
    @inlinable public func unwrap<NewValue>(
        orError error: Error
    ) -> EventLoopFutureOnCurrentEventLoop<NewValue> where Value == Optional<NewValue> {
